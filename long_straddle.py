...
ab = black_scholes(8899.45, 9000, 0.5, 0.667, 0.03, 0.0, 1) 
ac = black_scholes(8899.45 * 1.01, 9000, 0.5, 0.667, 0.03, 0.0, 1) 
print(ab)
print(ac)
...
client.sell('BTC-24APR20-12000-C', 0.5, 0.0145 )
import math
...
while True:
    ...
    while abc < len(calls):
        ...
        c2 = black_scholes(spot * 1.01, strikec[abc], diff, ivs[puts[abc]['instrumentName']], 0.03, 0.0, -1) 
        ...
        for e in exps:
            ...
            for c in calls:
                ...
                for p in puts:
                    ...
                    c2 = black_scholes(spot * 1.01, c, diff, pivs[p], 0.03, 0.0, -1) 
                   ...
                   # p3 = black_scholes(spot * (1-0.11), c, diff, civs[c], 0.03, 0.0, 1) 
                    ...
                    profit=(cost2-cost1)
                    #print(profit)
                    profits[profit] = {'price': costc[ccount], 'costc': costc[ccount], 'costp': costp[pcount],'call s' : c, 'put s': p, 'call': instsc[ccount],'put': instsp[pcount],  'e': e}
